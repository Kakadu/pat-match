...
keywords={run, conde, fresh, eigen, let, in, match, with, when, class, type,
...
%\newcommand{\wip}{\ding{119}}%
%\newcommand{\done}{\rlap{$\square$}{\raisebox{2pt}{\large\hspace{1pt}\cmark}}%
%\hspace{-2.5pt}}
%\newcommand{\wontfix}{\rlap{$\square$}{\large\xmark}}
\newcommand{\wip}{\faAdjust}
\newcommand{\done}{\faCheck}
