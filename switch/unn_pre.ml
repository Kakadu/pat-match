...
module Pattern = struct
  ...
  let rec inject : ground -> injected = function
    | WildCard -> wc ()
...
module Clauses = struct
  ...
  type injected =
    (Pattern.injected * IR.injected) OCanren.ilogic Std.List.injected
...
module type WORK = sig
  val eval_pat :
    Expr.injected -> Clauses.injected -> IR.injected Std.Option.injected -> goal
  ...
  val info_assoc :
    Typs.injected -> Tag.injected -> Typs.injected Std.List.injected -> goal
