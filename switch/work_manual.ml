...
let rec match1pat s p q109 =
  fresh q110
    ...
    ||| fresh
          ...
          (conde
             [
               fresh pairs (q114 === !!true) (list_combine ps es pairs)
                 (list_all
                    (fun z q116 ->
                      fresh (p e) (z === pair p e) (match1pat e p q116))
                    pairs q109);
    ...
    conde
      [
        ...
        fresh (p rhs ps q95)
          ...
          (conde
             [
               fresh q97 (q95 === !!true) (q97 === !!true) (rhs === q92)
                 (list_all
                    (fun p q100 ->
                      fresh q99 (match1pat s p q99)
                        (conde
                           [
                             q99 === !!true &&& (q100 === !!false);
                             q99 === !!false &&& (q100 === !!true);
  ...
  fresh xs
    ...
    (list_map
       (fun p q88 ->
         fresh (q86 q87 q89)
           (q88 === pair q86 q87)
           (fst p q86) (snd p q89) (list_length q89 q87))
       xs q85)
  ...
  conde
    [
      ...
      fresh (h tl q46)
        ...
        (q46 === !!false &&& not_in_history x tl q43
        ||| (q46 === !!true &&& (q43 === !!false)));
    ]

let rec eval_ir s max_height tinfo shortcut0 shortcut1 shortcut_apply_domain ir
    q42 =
        ...
        (conde
           [
             ...
             fresh
               ...
               (conde
                  [
                    fresh () (qtag === constr_hd)
                      (conde
                         [
                           qtag === etag
                           &&& inner next_histo test_list ontag q22;
                           qtag =/= etag &&& FD.neq qtag etag
                           &&& helper constr_tl clauses_tl q22;
                         ]);
                    qtag =/= constr_hd &&& (q27 === !!false)
